...
const Banner = () => {
    return (
        <div className="container mx-auto pb-12 mb-32 rounded-2xl shadow-2xl bg-white border-2 border-white">
           <div>
                ...
                <div className="flex justify-center items-center gap-3">
                    <input type="text" name="" placeholder="Search Any Doctor" id="" className=" w-160 bg-white border-b shadow-2xl p-3 rounded-full"/>
